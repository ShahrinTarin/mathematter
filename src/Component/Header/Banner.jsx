...
const Banner = () => {
    return (
<div className="hero bg-[url(https://i.ibb.co/KcBrKWK0/rubber-blank-paper-cute-pink-education-mathematics-powerpoint-background-a6aa809926-960-540.jpg)] min-h-[calc(100vh-64px)]">
  <div className="hero-content text-center">
    <div className="">
      <div className='text-center'>
                <motion.h1 animate={{y: [0, 15, 0]} }
                        transition={{duration: 5, repeat: Infinity}} className='text-3xl md:text-5xl font-medium text-center alegreya text-[#0F172A]'>Exploring <motion.span animate={{transition:{duration:6 ,repeat:Infinity} ,color:['#a8a432','#32a834','#3258a8','#5432a8','#a8328d','#a83242']} }>math</motion.span> through growth, <br /> discovery, and curiosity.</motion.h1>
