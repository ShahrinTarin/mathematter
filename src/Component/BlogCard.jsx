...
const BlogCard = ({blog}) => {
    ...
    <div className="relative flex  flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
      ...
      <div className="p-6 pt-0 flex justify-between flex-wrap gap-5">
        <NavLink to={`/blogdetails/${blog._id}`} className="relative rounded px-4 py-2 overflow-hidden group bg-[#1b9c8496] hover:bg-gradient-to-r hover:from-[#1b9c8444] hover:to-green-400 text-gray-700 hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300">
        ...
        <NavLink to='/wishlist'  className="relative rounded px-4 py-2 overflow-hidden group bg-[#1b9c842a] hover:bg-gradient-to-r hover:from-[#1b9c8444] hover:to-green-400 text-gray-700 hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300">
              <span className="absolute right-0 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
