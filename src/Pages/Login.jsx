...
const Login = () => {
    ...
    return (
        ...
        <div className=' py-5 lg:py-20'>
            <p className='text-center text-[#1b9c85] font-bold text-3xl md:text-4xl lg:text-5xl'>Please Login</p>
            <div className='grid  lg:grid-cols-2 justify-center items-center lg:w-8/12 mx-auto'>
                 
                <div>
                    <img className='rounded-2xl' src="https://i.ibb.co.com/3mvRm4wc/Myprofile.gif" alt="gif" />
                </div>
                <div className='px-3'>
                    <div className="w-full lg:max-w-md mx-auto p-8 mt-8 md:mt-16 space-y-3 rounded-xl bg-gray-600 text-gray-100 mb-5 shadow-2xl">
